...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/CRTSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "Primary output: \`doc/CRTSYSTEM.md\`" "index primary output"
...
require_contains "$ASSEMBLED_OUTPUT" "Primary output: \`doc/CRTSYSTEM.md\`" "assembled primary output"
